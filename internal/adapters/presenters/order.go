...
func NewOrderHandler(s *usecases.Order) *OrderHandler {
	return &OrderHandler{
		usecases: s,
	}
}
...
func (h *OrderHandler) CreateOrder(w http.ResponseWriter, r *http.Request) {
	...
	order, err := h.usecases.CreateOrder(ctx, orderDto)
	if err != nil {
...
func (h *OrderHandler) GetOrderByID(w http.ResponseWriter, r *http.Request) {
	...
	order, err := h.usecases.GetOrderByID(ctx, id)
	if err != nil {
...
func (h *OrderHandler) GetOrders(w http.ResponseWriter, r *http.Request) {
	...
	orders, err := h.usecases.GetOrders(ctx, page, size)
	if err != nil {
...
func (h *OrderHandler) SetOrderStatus(w http.ResponseWriter, r *http.Request) {
	...
	orderStatus, err := h.usecases.SetOrderStatus(ctx, id, status)
...
func (h *OrderHandler) FakeCheckout(w http.ResponseWriter, r *http.Request) {
	...
	_, err := h.usecases.SetOrderStatus(ctx, id, 1)
